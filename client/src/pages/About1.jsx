...
import sideDish from "../assets/images/side-dish.jpg";
  ...
  return (
    <main className="flex-auto m-6 rounded-lg bg-white p-6">
      <div className="sm:px-8 mt-9">
        <div className="mx-auto w-full max-w-7xl lg:px-8">
          <div className="mx-auto my-4 max-w-7xl px-4 sm:px-8 lg:px-12">
            <div className="ml-4 h-24 w-24  rounded-full flex items-center content-center overflow-hidden">
              <img
                src={hero}
                alt="hero"
          ...
          <div className="relative px-4 sm:px-8 lg:px-12">
            <div className="mx-auto max-w-2xl lg:max-w-5xl">
              <div className="max-w-2xl">
                <h1 className="text-4xl font-bold tracking-tight text-zinc-700 sm:text-5xl dark:text-zinc-100">
                  Software developer, founder, amateur chef.
                </h1>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto mt-4">
                  Welcome to{" "}
                  <span className="text-blue-600 font-semibold">RecipeApp</span>{" "}
                  — your trusted source for discovering and sharing incredible
      ...
      <section className="relative px-4 sm:px-8 lg:px-12">
        <h2 className="text-2xl font-semibold tracking-tight text-zinc-700 sm:text-3xl dark:text-zinc-100 mb-4">
          Our Story
        </h2>
        <p className="text-gray-700 leading-relaxed">
          It all started with a shared love for food and a frustration with
          cluttered recipe websites. We wanted something modern, clean, and
          community-driven — so we built RecipeApp. Whether you're a beginner
          learning to boil pasta or a foodie experimenting with global cuisines,
          we’re here to make cooking more joyful.
        </p>
      </section>
